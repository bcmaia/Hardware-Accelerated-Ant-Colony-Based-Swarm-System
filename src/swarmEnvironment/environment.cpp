...
void Environment::resetEnvironment()
{
    ...
    // Original version
    // NOTE (b): i found those four for loops here. I am not shure if this was
    //  a choice made with optimization in mind. However, some circumstances, 
    //  a loop such as this one loop might be compiled to efficient memsets or 
    //  SIMD instructions. So, this might be an optimal solution. Alternatively,
    //  a single loop might be better. Futher tests are needed.
