...
ParameterAssigner::ParameterAssigner(const char *filePath) {
    ...
    // A DEFINIÇÃO DO DATA_SIZE ACONTECE ANTES DAQUI NO .H, PRECISA RESOLVER
    // ISSO setScrHeight(2000); setScrWidth(2000);

    environmentParameters.placePheromoneRate =
        document["environment"]["placePheromoneRate"].GetInt();
    environmentParameters.pheromoneEvaporationRate =
        document["environment"]["pheromoneEvaporationRate"].GetInt();

    AnthillParameters *anthillParameterss =
        (AnthillParameters *)malloc(sizeof(AnthillParameters));
    ...
    anthillParameterss->antEspecification =
        document["anthills"][0]["antEspecifications"][0].GetInt();
    anthillParameterss->antAmount =
        document["anthills"][0]["antAmounts"][0].GetInt();
    this->anthillParameters.push_back(anthillParameterss);

    FoodSourceParameters *foodParameterss =
        (FoodSourceParameters *)malloc(sizeof(FoodSourceParameters));
    ...
    foodParameterss->foodAmount =
        document["foodSources"][0]["foodAmount"].GetInt();
    this->foodParameters.push_back(foodParameterss);

    FoodSourceParameters *foodParametersss =
        (FoodSourceParameters *)malloc(sizeof(FoodSourceParameters));
    ...
    foodParametersss->foodAmount =
        document["foodSources"][1]["foodAmount"].GetInt();
    this->foodParameters.push_back(foodParametersss);

    FoodSourceParameters *foodParameterssss =
        (FoodSourceParameters *)malloc(sizeof(FoodSourceParameters));
    ...
    foodParameterssss->foodAmount =
        document["foodSources"][2]["foodAmount"].GetInt();
    this->foodParameters.push_back(foodParameterssss);

    FoodSourceParameters *foodParametersssss =
        (FoodSourceParameters *)malloc(sizeof(FoodSourceParameters));
    ...
    foodParametersssss->foodAmount =
        document["foodSources"][3]["foodAmount"].GetInt();
    this->foodParameters.push_back(foodParametersssss);

    AntSensorParameters *antSensorParameters =
        (AntSensorParameters *)malloc(sizeof(AntSensorParameters));
    antSensorParameters->xCenterAntDistance =
        0.004; // document["ants"][0]["antSensorParameters"].GetDouble();
    ...
    AntParameters *antParameters =
        (AntParameters *)malloc(sizeof(AntParameters));
